...
## ----ra_comp, echo = FALSE, fig.cap ='Microbial composition at Family level for each sample by its relative abundance',   out.width = "100%", fig.width=12, fig.height=12, fig.pos="H"----
...
## ----alpha_div, echo = FALSE, fig.cap =' Alpha diversity metrics including Observed (A), Shannon (B) and Inverse Simpson (InvSimpson) (C) indices were probed for the two genotypes among different housing conditions.',   out.width = "100%", fig.width=12, fig.height=12, fig.pos="H"----
...
## ----beta_div, echo = FALSE, fig.cap =' PCoA: Bray-Curtis by Genotype, Housing and Sex',   out.width = "100%",fig.width=8, fig.height=6,  fig.pos="H"----
bray_pcoa <- ordinate(
  physeq = physeq_ra, 
  method = "PCoA", 
  distance = "bray"
...
## ----beta_div_unifrac, echo = FALSE, fig.cap =' PCoA: Unweighted Unifrac distance by Genotype, Housing and Sex',   out.width = "100%",fig.width=8, fig.height=6,  fig.pos="H"----
...
## ----bar_plot_lib_size, echo = FALSE, fig.cap ='Bar plot for library size per sample',  out.width = "100%", fig.width=12, fig.height=12, fig.pos="H"----
...
## ----pca, echo = FALSE, fig.cap =' PCA plot with Housing, Sex and Genotype.',  out.width = "100%", fig.width=8, fig.height=6,  fig.pos="H"----
...
## ----pca_box, echo = FALSE, fig.cap =' PCA plot with cage effect.', out.width = "100%", fig.width=8, fig.height=8,  fig.pos="H"----
...
## ----pca_sex, fig.show='hold', echo = FALSE, fig.cap =' PCA plot grouped by sex', fig.ncol = 2, out.width='.48\\linewidth',  fig.pos="H"----
...
## ----splsda_female, echo = FALSE,fig.show='hold', fig.cap ='Identification of OTU signatures associated with Housing and Genptype in Females using sPLS-DA',   out.width='.9\\linewidth', fig.pos="H"----
...
## ----splsda_male, echo = FALSE,fig.show='hold', fig.cap ='Identification of OTU signatures associated with Housing and Genptype in Males using sPLS-DA',   out.width='.9\\linewidth', fig.pos="H"----
...
## ----splsda_female_hd, echo = FALSE,fig.show='hold', fig.cap ='Identification of OTU signatures associated with Housing type in Female HD using sPLS-DA',  out.width='.5\\linewidth', fig.pos="H"----
p1


## ----splsda_female_hd_l, echo = FALSE, fig.cap ='Loadings of OTU signatures associated with Housing type in Female HD',  out.width='40%', fig.pos="H",fig.show='hold', fig.ncol=2, fig.height=10, fig.width=8----
...
## ----splsda_female_wt, echo = FALSE,fig.show='hold', fig.cap ='Identification of OTU signatures associated with Housing type in Female WT using sPLS-DA',  out.width='.6\\linewidth', fig.pos="H"----
p1


## ----splsda_female_wt_l, echo = FALSE, fig.cap ='Loadings of OTU signatures associated with Housing type in Female WT',  out.width='40%', fig.pos="H",fig.show='hold', fig.ncol=2, fig.height=10, fig.width=8----
...
## ----splsda_male_hd, echo = FALSE,fig.show='hold', fig.cap ='Identification of OTU signatures associated with Housing type in Male HD using sPLS-DA',  out.width='.6\\linewidth', fig.pos="H"----
p1


## ----splsda_male_hd_l, echo = FALSE, fig.cap ='Loadings of OTU signatures associated with Housing type in Male HD',  out.width='40%', fig.pos="H",fig.show='hold', fig.ncol=2----
...
## ----splsda_male_wt, echo = FALSE,fig.show='hold', fig.cap ='Identification of OTU signatures associated with Housing type in Male WT using sPLS-DA',  out.width='.8\\linewidth', fig.pos="H"----
p1


## ----splsda_male_wt_l, echo = FALSE, fig.cap ='Loadings of OTU signatures associated with Housing type in Male WT',  out.width='40%', fig.pos="H",fig.show='hold', fig.ncol=2, fig.height=10, fig.width=8----
